...
# Before cargo build
$env:RUSTFLAGS = "-C target-feature=+crt-static -C codegen-units=1 -C opt-level=3 -C link-arg=/NODEFAULTLIB:MSVCRT.lib -C link-arg=/DEFAULTLIB:libcmt.lib -C link-arg=/DEFAULTLIB:legacy_stdio_definitions.lib"
